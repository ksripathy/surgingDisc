...
# Surging disc post-processing routines
...
This repository contains the scripts used for processing data obtained from load cell and piv measurements in the surging actuator disc experiment. Scripts for load cell data processing are in the loadcell directory. Scripts for piv data processing are in the piv directory. Raw data from the experiments will be made available once the results have been published.
...
Python packages required for these processing scripts can be installed by importing `surgeDiscEnv.yml` conda environment file. Refer to the conda [documentation](https://docs.conda.io/projects/conda/en/latest/user-guide/tasks/manage-environments.html#creating-an-environment-from-an-environment-yml-file) on creating new environment using environment files.
