...
P45FstreamVelc = np.array([2.064786, 2.057820, 2.046670, 2.054451, 2.050731, 2.055419])
P45FstreamRho = np.array([1.187888, 1.187394, 1.186354, 1.186297, 1.186253, 1.186184])
...
expSurgeFreqP45 = np.array([1.273240, 1.273240, 1.273240, 2.122066, 3.183099, 4.244132])
...
noWindObjP45[3] = recordedForces(dataDir + "/clean2/P45k2a7p5clean.tdms", P45FstreamVelc[3], P45FstreamRho[3], 0.20, expSurgeFreqP45[3])
noWindObjP45[4] = recordedForces(dataDir + "/clean2/P45k3a7p5clean.tdms", P45FstreamVelc[4], P45FstreamRho[4], 0.20, expSurgeFreqP45[4])
noWindObjP45[5] = recordedForces(dataDir + "/clean2/P45k4a7p5clean.tdms", P45FstreamVelc[5], P45FstreamRho[5], 0.20, expSurgeFreqP45[5])
...
windObjP45[3] = recordedForces(dataDir + "/dynamic2/P45k2a7p5.tdms", P45FstreamVelc[3], P45FstreamRho[3], 0.20, expSurgeFreqP45[3])
windObjP45[4] = recordedForces(dataDir + "/dynamic2/P45k3a7p5.tdms", P45FstreamVelc[4], P45FstreamRho[4], 0.20, expSurgeFreqP45[4])
windObjP45[5] = recordedForces(dataDir + "/dynamic2/P45k4a7p5.tdms", P45FstreamVelc[5], P45FstreamRho[5], 0.20, expSurgeFreqP45[5])
...
P45Axs.hlines(np.mean(staticP45v12.forceSeries), xmin = 0, xmax = 1, color='k', label="staticAerov12")
P45Axs.hlines(np.mean(staticP45v2.forceSeries), xmin = 0, xmax = 1, color='k', linestyle="--", label="staticAerov2")
